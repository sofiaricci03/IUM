...
namespace Template.Web.Features.Login
{
    ...
    public partial class LoginController : Controller
    {
        ...
        private ActionResult LoginAndRedirect(UserDetailDTO utente, string returnUrl, bool rememberMe)
        {
            ...
            if (utente.Role == UserRole.Responsabile)
                return RedirectToAction("Index", "Dashboard", new { area = "Responsabile" });

            return RedirectToAction("Index", "Dashboard", new { area = "Dipendente" });
        }
        ...
        public virtual IActionResult Login(string returnUrl)
        {
            /*if (User?.Identity?.IsAuthenticated == true)
            {
                ...
                if (role == UserRole.Responsabile.ToString())
                    return RedirectToAction("Index", "Dashboard", new { area = "Responsabile" });
